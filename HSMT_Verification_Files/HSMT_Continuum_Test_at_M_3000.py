#!/usr/bin/env python3
"""
HSMT Phase 4 – Continuum Test at M=3000 (Further Refinement)
"""
...
class HSMT_Continuum_Test:
    ...
    def compute_geometric_criterion(self):
        n_eigen = max(400, int(self.M * 0.55))
...
if __name__ == "__main__":
    print("=" * 95)
    print("HSMT Phase 4 – Continuum Test at M=3000 (Further Refinement of Extrapolation)")
