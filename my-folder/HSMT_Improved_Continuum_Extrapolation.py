#!/usr/bin/env python3
"""
HSMT Phase 4 – Improved Continuum Extrapolation
(Linear + Quadratic fits vs Δρ and vs 1/M)
"""
...
# ============================================================
# Data from Controlled Continuum Test (Fixed Physical Volume L ≈ 12)
# ============================================================
M_values   = np.array([300, 600, 900, 1200, 1500, 1800])
delta_rho  = np.array([0.02000, 0.01000, 0.00667, 0.00500, 0.00400, 0.00333])
G_values   = np.array([1.5372, 1.0331, 0.8884, 0.7757, 0.6618, 0.5674])
one_over_G = np.array([0.6505, 0.9680, 1.1256, 1.2891, 1.5111, 1.7625])

one_over_M = 1.0 / M_values

print("=" * 85)
print("HSMT Phase 4 – Improved Continuum Extrapolation")
print("Fixed physical volume: L ≈ 12")
print("=" * 85)

# ============================================================
# 1. Linear Fit vs Δρ (reference)
# ============================================================
...
# ============================================================
print("\n" + "=" * 85)
print("Estimated Continuum Limit (Δρ → 0 or M → ∞)")
print("=" * 85)
