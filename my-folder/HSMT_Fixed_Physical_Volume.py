#!/usr/bin/env python3
"""
HSMT Phase 4 – Controlled Continuum Test (Finer Points: M=1500 & 1800)
"""
...
class HSMT_Continuum_Test:
    ...
    def compute_geometric_criterion(self):
        n_eigen = max(300, int(self.M * 0.55))
...
# ============================================================
# Controlled Continuum Test – Finer Points
# ============================================================
if __name__ == "__main__":
    print("=" * 110)
    print("HSMT Phase 4 – Controlled Continuum Test (Finer Points: M=1500 & 1800)")
    ...
    for M, phys_half in test_cases:
        model = HSMT_Continuum_Test(M=M, physical_half_length=phys_half)
    ...
    # Final summary table
    print("\n" + "=" * 110)
    print("Summary – Continuum Limit of Geometric Criterion at Fixed Physical Volume")
    print("=" * 110)
    print(f"{'M':>6} | {'Δρ':>10} | {'Central Sites':>14} | {'Δρ (region)':>13} | {'G':>8} | {'1/G':>8} | {'Time (s)':>10}")
    print("-" * 110)
    for r in results:
        print(f"{r['M']:6d} | {r['delta_rho']:10.5f} | {r['num_sites_central']:14d} | "
              f"{r['Delta_rho']:13.2f} | {r['G']:8.4f} | {r['one_over_G']:8.4f} | {r['wall_time_sec']:10.2f}")
    print("=" * 110)
