#!/usr/bin/env python3
"""
HSMT Phase 4 – Final Continuum Extrapolation (9 Data Points)
"""
...
# ============================================================
# Data (including new M=3600 point)
# ============================================================
M_values   = np.array([300, 600, 900, 1200, 1500, 1800, 2400, 3000, 3600])
delta_rho  = np.array([0.02000, 0.01000, 0.00667, 0.00500, 0.00400, 0.00333, 0.00250, 0.00200, 0.00167])
G_values   = np.array([1.5372, 1.0331, 0.8884, 0.7757, 0.6618, 0.5674, 0.5109, 0.4672, 0.4095])
one_over_G = np.array([0.6505, 0.9680, 1.1256, 1.2891, 1.5111, 1.7625, 1.9574, 2.1402, 2.4420])

one_over_M = 1.0 / M_values

print("=" * 100)
print("HSMT Phase 4 – Final Continuum Extrapolation (9 Data Points)")
...
# ============================================================
print("\n" + "=" * 100)
print("Estimated Continuum Limit (Δρ → 0 or M → ∞) – Final with 9 Points")
print("=" * 100)
